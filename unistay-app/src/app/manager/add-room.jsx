    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (imageUri) {
                ...
                response = await fetch(`${API_URL}/api/rooms`, {
                    method: 'POST',
                    headers: {
                ...
                // No image — send JSON (works reliably on all platforms)
                response = await fetch(`${API_URL}/api/rooms`, {
                    method: 'POST',
                    headers: {
                        'Authorization': `Bearer ${token}`,
            ...
            <View style={styles.container}>
                ...
                >
                    ...
                    <TouchableOpacity style={styles.imagePicker} onPress={pickImage} activeOpacity={0.8}>
                        {imageUri ? (
                            <Image source={{ uri: imageUri }} style={styles.imagePreview} contentFit="cover" transition={300} />
                        ) : (
